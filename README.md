...
```
$ mkdir -p $GOPATH/src/github.com/connectedservices
$ git clone https://github.com/connectedservices/confd.git $GOPATH/src/github.com/connectedservices/confd
$ cd $GOPATH/src/github.com/connectedservices/confd
$ make
```
