...
import (
	...
	"github.com/connectedservices/confd/backends/consul"
	"github.com/connectedservices/confd/backends/dynamodb"
	"github.com/connectedservices/confd/backends/env"
	"github.com/connectedservices/confd/backends/etcd"
	"github.com/connectedservices/confd/backends/etcdv3"
	"github.com/connectedservices/confd/backends/file"
	"github.com/connectedservices/confd/backends/rancher"
	"github.com/connectedservices/confd/backends/redis"
	"github.com/connectedservices/confd/backends/ssm"
	"github.com/connectedservices/confd/backends/vault"
	"github.com/connectedservices/confd/backends/zookeeper"
